...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2018 a las 02:35:32
...
ALTER TABLE `vuelo`
  ...
  ADD UNIQUE KEY `id_cliente` (`id_cliente`),
  ADD UNIQUE KEY `id_asiento` (`id_asiento`),
  ADD UNIQUE KEY `id_cuidad` (`id_cuidad`);
...
--
ALTER TABLE `ciudad`
  ADD CONSTRAINT `ciudad_ibfk_1` FOREIGN KEY (`id_ciudad`) REFERENCES `vuelo` (`id_cuidad`);

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `vuelo` (`id_cliente`);
...
ALTER TABLE `compra`
  ...
  ADD CONSTRAINT `compra_ibfk_2` FOREIGN KEY (`id_compra`) REFERENCES `cliente` (`id_cliente`);
COMMIT;
